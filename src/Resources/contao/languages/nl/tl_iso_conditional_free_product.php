...
$GLOBALS['TL_LANG']['tl_iso_conditional_free_product']['startTime'] = ['Starttijd', ''];
$GLOBALS['TL_LANG']['tl_iso_conditional_free_product']['endTime'] = ['Eindtijd', ''];
$GLOBALS['TL_LANG']['tl_iso_conditional_free_product']['enabled_legend'] = 'Actief/Inactief';
$GLOBALS['TL_LANG']['tl_iso_conditional_free_product']['enabled'] = ['Actief', ''];